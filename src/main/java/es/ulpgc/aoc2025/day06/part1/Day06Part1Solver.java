...
public class Day06Part1Solver implements PuzzleSolver {

    private final MathWorksheetParser parser = new MathWorksheetParser();
    private final HorizontalMathWorksheetProblemExtractor extractor = new HorizontalMathWorksheetProblemExtractor();
